...
best_clf = joblib.load('D:/DjangoProjects/woow-academy-backend/random_forest_model_2.pkl')
imputer = joblib.load('D:/DjangoProjects/woow-academy-backend/random_forest_imputer_2.pkl')
...
def predict_level(request):
    ...
    impute_cols = ['job_title', 'education', 'skills_name', 'min_experience']

    random_data_encoded = pd.get_dummies(random_data[impute_cols])
